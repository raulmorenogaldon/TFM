...
Actualmente hay mucho software que implementa este modelo como puede ser el conocido \textit{Hadoop}, \textit{Hive}, \textit{Cascalog}, \textit{mrjob}\dots A continuación \textit{Hadoop} será comentado más en detalle.\\
