...
En cambio, el uso del modelo de \textit{PGAS} no se considera factible en esta Tesis. Esto es debido a que la capa de virtualización, para dar la visión de memoria compartida, es costosa en prestaciones. Debido a la sobrecarga a la que somete al sistema y puesto que estamos en entornos de altas prestaciones, no se utilizará al no considerarse necesaria.\\
