\section{Modelos para el análisis y diseño de sistemas concurrentes}
...
Adicionalmente se presentan las principales herramientas que dan soporte a dichos modelos como por ejemplo \textit{Uppaal}\cite{uppaalweb} y cuales son las técnicas de análisis de propiedades que utilizan.\\
...
Lo visto en esta asignatura me sirve para modelar un sistema y que analizando su modelo pueda determinar sus propiedades más importantes. Estas propiedades pueden ser la aparición de bloqueos por ejemplo, o que un determinado elemento del programa llegue a ejecutarse alguna vez. Además, mediante la validación del modelo podemos determinar si realmente un programa se comporta como queremos.\\
