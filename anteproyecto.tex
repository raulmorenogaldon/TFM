...
%\fbox{
\begin{center}
\begin{PstGanttChart}[yunit=1.0,xunit=2.2,ChartUnitIntervalName=A\~no,
                      ChartUnitBasicIntervalName=Month,
                      TaskUnitIntervalValue=12,TaskUnitType=Month,
                      TaskOutsideLabelMaxSize=4,ChartShowIntervals]{13}{48}
  \psset{gradangle=90,TaskStyle=TaskStyleC}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{0}},TaskInsideLabel={\footnotesize{Master (10)}}]{0}{10}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{1}},TaskInsideLabel={\footnotesize{Estado del Arte (4)}}]{6}{4}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{2}},TaskInsideLabel={\footnotesize{Estudio de estructuras (6)}}]{9}{6}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{3}},TaskInsideLabel={\footnotesize{Pruebas preliminares sobre GPUs y CPUs (8)}}]{12}{8}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{4}},TaskInsideLabel={\footnotesize{Seleccio (8)}}]{18}{8}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{9}},TaskStyle=TaskStyleD,TaskInsideLabel={\footnotesize{Difusn}}]{18}{8}
  \psset{TaskStyle=TaskStyleC}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{5}},TaskInsideLabel={\footnotesize{Implementaciones sobre GPUs (6)}}]{24}{6}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{6}},TaskInsideLabel={\footnotesize{Multicores (6)}}]{30}{6}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{9}},TaskStyle=TaskStyleD,TaskInsideLabel={\footnotesize{Difusion}}]{30}{8}
    \psset{TaskStyle=TaskStyleC}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{7}},TaskInsideLabel={\footnotesize{Clusters de CPUs (6)}}]{36}{6}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{8}},TaskInsideLabel={\footnotesize{C. Hibridos (6)}}]{41}{6}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{9}},TaskStyle=TaskStyleD,TaskInsideLabel={\footnotesize{Difusion}}]{40}{8}
  \PstGanttTask[TaskOutsideLabel={\footnotesize{10}},TaskStyle=TaskStyleA,TaskInsideLabel={\footnotesize{Documentacion y escritura Tesis Doctoral}}]{14}{34}
\end{PstGanttChart}
\end{center}
%}%end fbox
\caption{Diagrama Gant: desarrollo de la tesis de doctorado.}
\label{fig:gantt}
\end{figure}
%\end{landscape}
%-----------------
