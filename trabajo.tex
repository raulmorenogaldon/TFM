...
Esta tarea está en progreso pero ya hay alguna parte del código que la implementa.\\

\subsection{Pruebas SSE en el recalibrador}

Esta tarea se ha iniciado de forma parcial. Ya se ha realizado alguna prueba sobre las instrucciones SSE que se van incorporando. cuyos resultados se encuentran. Como se verá en la sección \ref{sec:evaluacion}, se ha incrementado bastante el rendimiento con unos pequeños cambios en el código de la versión anterior. Esto indica la factibilidad de usar las instrucciones SSE en el desarrollo.\\
...
Los dos recalibradores han realizado el mismo proceso de recalibrado en las mismas condiciones, teniendo en cuenta la posición de las bases, su ciclo de secuenciador y su entorno de dinucleótido.\\