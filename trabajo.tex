...
Los formatos \textit{BAM/SAM} contienen la misma información aunque en diferente formato. Están compuestos por una cabecera opcional, que contiene información adicional sobre el fichero y las lecturas, seguida de las lecturas de secuenciación. Cada lectura contiene información de la secuencia de ADN que contiene y cómo se alinea con el ADN de referencia.\\

\section{Tareas completadas o en progreso}

\subsection{Estado del arte}

Se ha completado la tarea de búsqueda de información y obtención del estado del arte sobre las herramientas disponibles para el análisis de ADN, tecnologías paralelas útiles para aumentar el rendimiento de dichas herramientas y formas de tratar grandes cantidades de datos.
